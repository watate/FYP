...
velocity_list_filename = 'normal_simple_velocity_list.dat'
replay_buffer_filename = 'replay_buffer.dat'
current_date_time = time.strftime("%Y%m%d-%H%M%S")

config_notes = """Collecting velocity data for normal simple model""" #Write stuff here to explain what training was for
# ===========================
